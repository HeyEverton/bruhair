            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('pdv')" :active="route().current('pdv')">
                                    PDV
                                </NavLink>
                            </div>

                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('pdv.orders')" :active="route().current('pdv.orders')">
                                    Vendas
                                </NavLink>
                            </div>
                ...
                <div :class="{
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('pdv')" :active="route().current('pdv')">
                            PDV
                        </ResponsiveNavLink>
                    </div>

                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('pdv.orders')" :active="route().current('pdv.orders')">
                            Vendas
                        </ResponsiveNavLink>
                    </div>
